...
TEST 0.1 — Find open port
  Status:   PASS
  Expected: Port found and written to reports/server-port.md
  Received: Port 3003 found and written to reports/server-port.md

TEST 0.2 — Install dependencies
  Status:   PASS
  Expected: Exit code 0
  Received: Exit code 0 (69 packages audited, 0 vulnerabilities)

TEST 0.3 — Start server
  Status:   PASS
  Expected: Server process started (nohup, PID written to /tmp/calc-server.pid)
  Received: PID 46549, log: "Calculator API running on port 3003"

TEST 0.4 — Health check
  Status:   PASS
  Expected: Any valid HTTP response (not connection refused)
  Received: HTTP 400 (valid response received)
...
=====================================
RESULTS: 38 passed, 0 failed out of 38
